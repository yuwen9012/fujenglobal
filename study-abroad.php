            ...
            <div class="col-md-6 d-flex align-items-end">
                <div class="container text-center">
                    <div class="half-circle">
                        ...
                        <div class="circle-btn" id="btn-traditional-culture"><a href="traditional-culture.php">Traditional Culture</a></div>
                        <div class="circle-btn" id="btn-enterprise-visit"><a href="https://bpis.fju.edu.tw/index.php">Enterprise Visit</a></div>
                        <div class="circle-btn" id="btn-mandarin-learning"><a href="Mandarin-Chinese-Learning-Carousel.php">Mandarin Learning</a></div>
