<div class="tab-pane fade" id="communication" role="tabpanel" aria-labelledby="communication-tab">
    ...
    <div class="my-5" id="introduction-communication">
        <div class="row align-items-start">
            ...
            <div class="col-md-6">
                <img src="images/study-package/communication/傳播學院_introduction.jfif" class="container-fluid">
            </div>
        </div>
    </div>
    ...
    <div class="my-5" id="amsp-communication">
        <div class="row align-items-start">
            <div class="col-md-6">
    ...
    <div class="my-5" id="lo-communication">
        <div class="row align-items-start">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <img src="images/study-package/communication/傳播學院_outcomes.jpg" class="container-fluid">
            </div>
        </div>
    </div>
    ...
    <div class="my-5" id="rf-communication">
        <div class="row align-items-start">
            <div class="col-md-6">
