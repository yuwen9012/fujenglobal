<div class="tab-pane fade" id="foreign" role="tabpanel" aria-labelledby="foreign-tab">
    ...
    <div class="my-5" id="introduction-foreign">
        <div class="row align-items-start">
            <div class="col-md-6">
                ...
                <div class="justify-text">
                    ...
                    <a id="read-more-link-forei-intro" data-bs-toggle="collapse" href="#collapseForeiIntro" role="button" aria-expanded="false" aria-controls="collapseForeiIntro">Read more...</a>
                </div>   
            </div>
            <div class="col-md-6">
                <img src="images/study-package/foreign-languages/外語學院_introduction.jpg" class="container-fluid">
            </div>
        </div>
    </div>
    ...
    <div class="my-5" id="features-foreign">
        <div class="row align-items-start">
            ...
            <div class="col-md-6 order-1 order-md-2">
                ...
                <div class="justify-text">
                    <div class="continueDecimal" id="collapseForeiFeatu">
                        <ul>
                            <li>
    ...
    <div class="my-5" id="amsp-foreign">
        <div class="row align-items-start">
            <div class="col-md-6">
                <h3 class="my-3 fw-semibold">Academic Module & Study Package</h3>
                <div class="justify-text">
                    <div class="continueDecimal" id="collapseForeiAmsp">
                        <ul>
                            <li>
    ...
    <div class="my-5" id="ow-foreign">
        ...
        <a href="http://www.cfl.fju.edu.tw/" target="_blank">http://www.cfl.fju.edu.tw/</a>
    </div>
    ...
    <div class="my-5" id="ci-foreign">
        ...
        <span class="my-3">Chair&Associate Professor, Meng-Jen Chang<br>Tel: 886-2-2905-3761<br>E-mail: 076485@mail.fju.edu.tw<br><br></span>
        <span class="my-3 fw-semibold">Secretaries<br></span>
        <span class="my-3">Ms.Chen<br>Tel:886-2-2905-2551<br>E-mail: 004617@mail.fju.edu.tw<br>
        Ms.Hao<br>Tel:886-2-2905-3718<br>E-mail: 026549@mail.fju.edu.tw
        Ms.Zhuang<br>Tel:886-2-2905-3307<br>E-mail: 161279@mail.fju.edu.tw</span>
    </div>
</div>
