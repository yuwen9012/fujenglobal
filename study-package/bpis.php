<div class="tab-pane fade show active" id="bpis" role="tabpanel" aria-labelledby="bpis-tab">
    <h3 class="my-3 fw-bolder">Fu Jen Global Academy Bachelors’ Program in Interdisciplinary Studies</h3>

    <ul class="navbar-nav d-flex flex-row flex-wrap">
        <li class="nav-item m-1">
            <a class="nav-link btn" href="#introduction-bpis" data-scroll="true">Introduction</a>
        </li>
        <li class="nav-item m-1">
            <a class="nav-link btn" href="#features-bpis" data-scroll="true">Features</a>
        </li>
        <li class="nav-item m-1">
            <a class="nav-link btn" href="#amsp-bpis" data-scroll="true">Academic Module & Study Package</a>
        </li>
        <li class="nav-item m-1">
            <a class="nav-link btn" href="#csd-bpis" data-scroll="true">Course Structure & Description</a>
        </li>
        <li class="nav-item m-1">
            <a class="nav-link btn" href="#lo-bpis" data-scroll="true">Learning Outcomes</a>
        </li>
        <li class="nav-item m-1">
            <a class="nav-link btn" href="#fi-bpis" data-scroll="true">Faculty Information</a>
        </li>
        <li class="nav-item m-1">
            <a class="nav-link btn" href="#rf-bpis" data-scroll="true">Resources & Facilities</a>
        </li>
        <li class="nav-item m-1">
            <a class="nav-link btn" href="#ow-bpis" data-scroll="true">Office Website</a>
        </li>
        <li class="nav-item m-1">
            <a class="nav-link btn" href="#ci-bpis" data-scroll="true">Contact Information</a>
        </li>
    ...
    <div class="my-5" id="ow-bpis">
        <h3 class="my-3 fw-semibold">Office Website</h3>
        <a href="https://bpis.fju.edu.tw/" target="_blank">https://bpis.fju.edu.tw/</a>
    </div>

    <div class="my-5" id="ci-bpis">
        <h3 class="my-3 fw-semibold">Contact Information</h3>
        <p class="my-3">Melody: bpis@mail.fju.edu.tw</p>
        <p class="mt-3">Chair</p>
        <p class="my-3">Ariana Chang</p>
        <p class="my-3">Email: 140517@mail.fju.edu.tw</p>
        <p class="my-3">Tel: +886-2-29053099</p>
    </div>
</div>
