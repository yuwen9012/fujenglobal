...
(3, 'Application', 'What are the costs?', 'Registration fee - USD 150；Program fee - USD 3,500'),
...
(10, 'Before Enter Taiwan', 'What are enrollment documents?', 'Pease submit the following documents after you\'ve been admitted. Save full-color scanned copies of the documents below in a single PDF file and send it to the following email addresses before the deadlines: XXX@mail.fju.edu.tw<br>FJCU will email the Acceptance Letter (soft copy) only after receiving documents 1 and 2 below.<br>Document 1 Health Certificate and Medical Reports (submission deadline of Fall 2024: 7/15. If unable to submit in time, please email us in advance to inform us of the expected submission date.)<br>1. FJCU uses the Health Certificate for Residence Application issued by the Ministry of Health and Welfare. Please make sure to use that form for your medical examination.<br>2. Please complete all sections of the form. Copies of all related medical reports must also be submitted.<br>Document 2 Emergency Authorization Form (submission deadline of Fall 2024: 7/15)<br>1. Download the Emergency Authorization Form.<br>Document 3 International accident and medical insurance (shall be submitted at least two weeks before your arrival)<br>1. Before leaving for Taiwan, you must purchase insurance from your country to cover your entire stay in Taiwan.<br>2. Insurance must cover the following:<br>◆Accidental death or disability<br>◆ Medical treatment for accidents and sickness (outpatient and inpatient treatment)<br>◆ Emergency repatriation and transport<br>The University does not provide insurance to exchange students. Please ensure that you purchase sufficient coverage. We strongly urge students purchase more than the bare minimum – better safe than sorry!'),
(11, 'Before Enter Taiwan', 'What are the visa and entry requirements?', '1. Exchange students who study for one semester must apply for a Visitor Visa. Please purchase your plane tickets after you have obtained the visitor visa so that you know what date you must depart Taiwan. Students enrolled for the fall semester must depart Taiwan in January; students enrolled for the spring semester must depart Taiwan in June.<br>2. Exchange students must not enter Taiwan on a landing visa. Exchange students are ineligible for the visa waiver program.<br>【African swine fever】<br>1. Help prevent the spread of African swine fever by following the regulations below:<br>◆ Do not purchase meat products abroad and bring them to Taiwan.<br>◆ Do not purchase meat products online from a source abroad.<br>◆ Do not visit livestock farms.<br>2. Travelers may be fined up to NT$1,000,000 for purchasing meat products while abroad and bringing them to Taiwan. (Vacuum-sealed meat products are likewise prohibited). The illegal shipping, online purchase, or smuggling of meat products into Taiwan could result in a jail sentence of up to seven years, plus an additional fine of up to NT$3,000,000.<br>3. Please click on the links below for more details:<br>◆ World Organisation for Animal Health (OIE)<br>◆ Bureau of Animal and Plant Health Inspection and Quarantine in Taiwan (in Chinese only)'),
(12, 'Live in Taiwan', 'What are the costs for Living?', 'Accommodation fee: On-campus dormitory: free；Off-campus: TBC<br>Living expenses<br>Comparison between New Taipei City and Taipei<br>Transportation fee<br>Taipei MRT: NT$ 20-65 per trip<br>Taoyuan MRT: NT$ 30-160 per trip<br>Bus fare in Taipei: NT$15 per trip'),
...
(18, 'Live in Taiwan', 'How do I get to campus?', 'Fu Jen<br>1. Address: 510 Zhongzheng Rd., Xinzhuang Dist., New Taipei City 242062, Taiwan (R.O.C.)<br>2. The University’s main entrance is located on Zhongzheng Road. The rear entrance is located on Santai Road.<br>From Taoyuan International Airport<br>1. By Taxi: The taxi ride usually takes 1 hour and costs approximately NT$1,300.<br>2. MRT: Take the Taoyuan MRT to A2 Sanchong Station, then transfer to the Taipei MRT orange line and get off at O19 Fu Jen University Station. The main entrance to the University is right outside Exit 1. The ride takes about 1~1.5 hours.<br>From Taipei Songshan Airport<br>1. MRT: Take the orange line to O19 Fu Jen University Station. The main entrance to the University is right outside Exit 1. The ride takes about 1 hour<br>Websites<br>1. <a href=\"http://www.taoyuan-airport.com/english/transportation\" target=\"_blank\">Taoyuan International Airport</a><br>2. <a href=\"http://www.tsa.gov.tw/tsa/en/page.aspx?id=1059\" target=\"_blank\">Songshan Airport</a><br>3. <a href=\"https://www.tymetro.com.tw/tymetro-new/en/index.php\" target=\"_blank\">Metro Taoyuan (MRT)</a><br>4. <a href=\"https://english.metro.taipei/Default.aspx\" target=\"_blank\">Metro Taipei (MRT)</a>'),
