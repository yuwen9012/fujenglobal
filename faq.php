...
<body>
    ...
    <div class="container my-5 content">
        <div class="d-flex justify-content-center my-3" id="ul-link">
            <!-- <ul class="navbar-nav d-flex flex-row flex-wrap">
                <li class="nav-item m-1">
                    <a class="nav-link btn fs-5" href="#choose-your-units" data-scroll="true">Choose your units</a>
                </li>
                <li class="nav-item m-1">
                    <a class="nav-link btn fs-5" href="#application" data-scroll="true">Application</a>
                </li>
                <li class="nav-item m-1">
                    <a class="nav-link btn fs-5" href="#before-enter-taiwan" data-scroll="true">Before Enter Taiwan</a>
                </li>
                <li class="nav-item m-1">
                    <a class="nav-link btn fs-5" href="#live-in-taiwan" data-scroll="true">Live in Taiwan</a>
                </li>
                <li class="nav-item m-1">
                    <a class="nav-link btn fs-5" href="#contact-us" data-scroll="true">Contact us</a>
                </li>
        ...
        <div id="faqs">
            <!-- <div class="accordion accordion-flush my-3" id="units">
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapse-sect1-1" class="accordion-collapse collapse" data-bs-parent="#units">
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapse-sect1-2" class="accordion-collapse collapse" data-bs-parent="#units">
                        <div class="accordion-body">
            ...
            <div class="accordion accordion-flush my-3" id="application">
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapse-sect2-1" class="accordion-collapse collapse" data-bs-parent="#application">
                        <div class="accordion-body">
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapse-sect2-2" class="accordion-collapse collapse" data-bs-parent="#application">
                        <div class="accordion-body">
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapse-sect2-3" class="accordion-collapse collapse" data-bs-parent="#application">
                        <div class="accordion-body">
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapse-sect2-4" class="accordion-collapse collapse" data-bs-parent="#application">
                        <div class="accordion-body">
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapse-sect2-5" class="accordion-collapse collapse" data-bs-parent="#application">
                        <div class="accordion-body">
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapse-sect2-6" class="accordion-collapse collapse" data-bs-parent="#application">
                        <div class="accordion-body">
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapse-sect2-7" class="accordion-collapse collapse" data-bs-parent="#application">
                        <div class="accordion-body">
