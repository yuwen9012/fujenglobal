            ...
            <div class="row">
                <div class="col-md-3 text-center">
                    ...
                    <ul class="list-unstyled">
                        <p>Office of International Education Room 112, Cardinal Tien Memorial Hall 510 Zhongzheng Rd., Xinzhuang Dist.,Taipei, Taiwan 242062</p>
                    </ul>
                </div>
                <div class="col-md-3 text-center with-divider">
                    <i class="fas fa-link"></i>
                    <h5>Link</h5>
                    <ul class="list-unstyled">
                        <li><a href="https://www.fju.edu.tw/indexEN.jsp">https://www.fju.edu.tw/indexEN.jsp</a></li>
                        <li><a href="https://www.fju.edu.tw/indexEN.jsp">https://www.fju.edu.tw/indexEN.jsp</a></li>
                        <li><a href="https://www.fju.edu.tw/indexEN.jsp">https://www.fju.edu.tw/indexEN.jsp</a></li>
                    </ul>
                </div>
                ...
                <div class="col-md-3 text-center with-divider">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <p>+886-2-2905-3358</p>
                        <p>International Student Admission</p>
                        <p>+886-2-2905-2944</p>
