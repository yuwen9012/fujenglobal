...
-->
<div class="container">
    <p class="heading">Event Participation by Student Type</p>
    <p class="custom-mark">Legend:  <br>   ✔: Welcome to join!  <br>     ⭘: Depends on the actual situation<br>    ✘: Not eligible</p>
      ...
      <table class="table table-striped custom-table-hover">
        <thead>
          <tr class="text-center">
            <th class="table-h">Event Category</th>
            <th class="table-h" style="width: 40%;">Event Name</th>
            <th class="table-h">Study Abroad Student</th>
            <th class="table-h">Regular Exchange Student</th>
            <th class="table-h">CCLC Student</th>
          </tr>
        </thead>
        <tbody class="text-center">
          <tr data-description="col1">
            <td class="table-h" rowspan="5">ISC Events <br>(Fee-based)</td>
            <td>One-day Trip to Hakka City</td>
            <td>✔</td>
            <td>✔</td>
            <td>⭘</td>
          </tr>
          <tr data-description="col2">
            <td>Half-day Trip to Northern Suburbs</td>
            <td>✔</td>
            <td>✔</td>
            <td>⭘</td>
          </tr>
          <tr data-description="col3">
            <td>Traditional Culture Activities</td>
            <td>✔</td>
            <td>✔</td>
            <td>⭘</td>
          </tr>
          <tr data-description="col4">
            <td>Paintball Game</td>
            <td>✔</td>
            <td>✔</td>
            <td>⭘</td>
          </tr>
          <tr data-description="col5">
            <td>Indigenous Tribes Visiting</td>
            <td>✔</td>
            <td>✔</td>
            <td>⭘</td>
          </tr>
          <tr data-description="col6">
            <td class="table-h" rowspan="5">ISC Events<br>(Free)</td>
            <td>Welcome Party</td>
            <td>✔</td>
            <td>✔</td>
            <td>⭘</td>
          </tr>
          <tr data-description="col7">
            <td>Gourmet Food Day</td>
            <td>✔</td>
            <td>✔</td>
            <td>⭘</td>
          </tr>
          <tr data-description="col8">
            <td>Series of Celebrations for University Anniversary</td>
            <td>✔</td>
            <td>✔</td>
            <td>⭘</td>
          </tr>
          <tr data-description="col9">
            <td>Intercultural Opera Theatre</td>
            <td>✔</td>
            <td>✔</td>
            <td>⭘</td>
          </tr>
          <tr data-description="col10">
            <td>Taiwanese Culture Workshop</td>
            <td>✔</td>
            <td>✔</td>
            <td>⭘</td>
          </tr>
          <tr data-description="col11">
            <td class="table-h" rowspan="4">CCLC Events <br>(Fee-based)</td>
            <td>Spring Field Trip to Yilan National Center for Traditional Arts</td>
            <td>✔</td>
            <td>✘</td>
            <td>✔</td>
          </tr>
          <tr data-description="col12">
            <td>Fall Field Trip to Taiwan Hakka Tea Culture Museum</td>
            <td>✔</td>
            <td>✘</td>
            <td>✔</td>
          </tr>
          <tr data-description="col13">
            <td>Moon Festival Cultural Trip to Kuo Yuan Yi Museum of Cake & Pastry</td>
            <td>✔</td>
            <td>✘</td>
            <td>✔</td>
          </tr>
          <tr data-description="col14">
            <td>Christmas Dinner Party (including a sumptuous dinner and multi-national cultural program)</td>
            <td>✔</td>
            <td>✘</td>
            <td>✔</td>
          </tr>
          <tr data-description="col15">
            <td class="table-h" rowspan="3">CCLC Events <br>(Free)</td>
            <td>Lunar New Year Cultural Activity * (Festive foods will be offered during the activity)</td>
            <td>✔</td>
            <td>⭘</td>
            <td>✔</td>
          </tr>
          <tr data-description="col16">
            <td>CCLC International Cultural Festival * (Festive foods will be offered during the activity)</td>
            <td>✔</td>
            <td>⭘</td>
            <td>✔</td>
          </tr>
          <tr data-description="col17">
            <td>Dragon Boat Festival Cultural Activity * (Festive foods will be offered during the activity)</td>
            <td>✔</td>
            <td>⭘</td>
            <td>✔</td>
          </tr>
          <tr data-description="col18">
            <td class="table-h">Special Event</td>
            <td>Two guaranteed free events</td>
            <td>✔</td>
            <td>Fee-paying</td>
            <td>Fee-paying</td>
          </tr>
